package br.com.spring.jdev.demo.controller;
...
import br.com.spring.jdev.demo.repository.UsuarioRepository;
...
public class UsuarioController {
	...
	public ResponseEntity<?> atualizar(@RequestBody Usuario usuario) { /* Recebe os dados para atualizar */
		...
		if (usuario.getId() == null) {
			return new ResponseEntity<String>("id não foi informado para atulização", HttpStatus.OK);
		}
	...
	@ResponseBody /* Descricao da resposta */
	public ResponseEntity<String> delete(@RequestParam Long iduser) { /* recebe os dados para deleta */
